...
//******************************************************************************
//
// File:    URLCounterRunnable.java
// Package: ---
// Unit:    Class URLCounterRunnable
//
...
/**
 * Class URLCounterRunnable provides an object that counts lines, words, and
 * bytes in the data obtained from a URL and prints the results; it implements
 * interface {@link java.lang.Runnable </CODE>Runnable<CODE>} but does not
 * extend class {@link java.lang.Thread </CODE>Thread<CODE>}.
 *
 * @author  Alan Kaminsky
 * @version 06-Sep-2013
 */
public class URLCounterRunnable
	implements Runnable
	{
